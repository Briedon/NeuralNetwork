...
int main(int argc, const char * argv[]) {
    for(int testnumber=0;testnumber<2;testnumber++){
        ...
        for(int number_of_layer=0;number_of_layer<=layer;number_of_layer++) {
            ...
            MatrixXf matrix(node_of_layer.size(),input_of_layer.size()+1);
            MatrixXf ones(node_of_layer.size(),input_of_layer.size()+1);
